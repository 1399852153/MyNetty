 ...
 * under the License.
 */
package com.my.netty.bytebuffer.netty.util.queue;

import java.util.Arrays;

/**
 * 优先级队列，用于PoolChunk(完全copy自netty的LongPriorityQueue类)
 * 优先级队列的基本工作原理可以参考我的博客：https://www.cnblogs.com/xiaoxiongcanguan/p/10421560.html
 */
